...
from blog.models import Tag, Category, User, Blog, Link, Comment, UploadFileModel, FeedBackMode, UserVisitFoot
...
class BlogAdmin(admin.ModelAdmin):
    list_display = ('title', 'publish_time', 'update_time', 'category', 'read_num', 'comment_num')
...
class FeedBackAdmin(admin.ModelAdmin):
    list_displa = ('username', 'useremail', 'suggestion', 'feedback_time')
    list_per_page = 10
